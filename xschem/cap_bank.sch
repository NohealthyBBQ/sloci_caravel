...
C {devices/ipin.sym} 330 -200 0 0 {name=p2 lab=GND
}
C {devices/ipin.sym} 540 -440 0 0 {name=p3 lab=ctrll1}
C {devices/ipin.sym} 690 -440 0 0 {name=p4 lab=ctrll2}
C {devices/ipin.sym} 820 -440 0 0 {name=p5 lab=ctrll3}
C {devices/ipin.sym} 960 -440 0 0 {name=p6 lab=ctrll4}
C {devices/ipin.sym} 1090 -440 0 0 {name=p7 lab=ctrll5}
