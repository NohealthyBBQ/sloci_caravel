...
spiceprefix=X
mult=1}
C {devices/ipin.sym} 100 -450 0 0 {name=p2 lab=VDD}
C {devices/ipin.sym} 140 30 0 0 {name=p3 lab=SUB}
C {devices/ipin.sym} 140 -20 0 0 {name=p4 lab=GND}
C {devices/ipin.sym} 70 -210 0 0 {name=p5 lab=IN1}
C {devices/ipin.sym} 220 -210 0 0 {name=p6 lab=IN2}
C {devices/ipin.sym} 430 -210 0 0 {name=p7 lab=IN3}
C {devices/ipin.sym} 580 -210 0 0 {name=p8 lab=IN4}
C {devices/opin.sym} 720 -140 0 0 {name=p1 lab=AMP}
